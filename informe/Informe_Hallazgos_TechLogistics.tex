...
Las figuras siguientes se generan con las mismas agregaciones y variables que
las visualizaciones de Streamlit. Cada figura corresponde al punto analítico
que se desarrolla en las secciones posteriores.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.65\textwidth]{tex_figures/03_venta_invisible.png}
