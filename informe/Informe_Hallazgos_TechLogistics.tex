...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{tex_figures/01_margen_negativo.png}
\caption{SKUs con mayor margen negativo.}
\end{figure}
...
débil: el valor absoluto máximo observado es aproximadamente 0,05 en
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{tex_figures/06_matriz_correlacion.png}
...
\caption{Zonas ciudad--bodega con menor NPS y mayor presión logística.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tex_figures/03_venta_invisible.png}
\caption{Ingreso correspondiente a SKU sin catálogo oficial.}
\end{figure}
...
\caption{Stock alto frente a NPS negativo.}
\end{figure}
...
\caption{Antigüedad de revisión frente a tickets por bodega.}
\end{figure}
